...
$from_email = 'rogerfedererx@126.com'; //Webmaster email
$from_name = 'Pin_Xu'; //"From name" displayed on email

//Find specific server settings at https://www.arclab.com/en/kb/email/list-of-smtp-and-pop3-servers-mailserver-list.html
$mailServerType = 'smtp';
//IF $mailServerType = 'smtp'
$smtp_server = 'smtp.126.com';
$smtp_user = 'rogerfedererx@126.com';
$smtp_pw = 'Krf3b0YKwcBrf53h';
...
$activemsg = 'Your account has been verified! You may now login at <br><a href="'.$base_url.'">'.$base_url.'</a>';
